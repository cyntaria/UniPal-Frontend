...
class RequestsProvider {
  ...
  final _receivedConnectionRequests = [
    {
  ...
  List<JSON> getAllSentConnectionRequests() {
    return [
      ..._sentConnectionRequests,
      ..._sentConnectionRequests,
      ..._sentConnectionRequests,
    ];
  }

  List<JSON> getAllReceivedConnectionRequests() {
    return [
      ..._receivedConnectionRequests,
      ..._receivedConnectionRequests,
      ..._receivedConnectionRequests,
    ];
  }
